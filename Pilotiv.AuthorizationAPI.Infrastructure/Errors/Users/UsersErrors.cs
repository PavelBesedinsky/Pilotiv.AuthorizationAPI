...
public static class UsersErrors
{
    ...
    public static Error UserNotFoundByRefreshTokenId(RefreshTokenId refreshTokenId) =>
        new($"Не удалось найти пользователя по идентификатору токена обновления ({refreshTokenId.Value})");
